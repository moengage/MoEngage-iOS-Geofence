...
/// \param locationManager <code>CLLocationManager</code> instance
///
/// \param region <code>CLRegion</code> instance that represents an area that can be monitored.
///
...
/// \param appID MoEngage Account Identifer
///
...
/// \param delegate Class instance that conforms to <code>MoEngageGeofenceDelegate</code> protocol.
///
- (void)setGeofenceDelegate:(id <MoEngageGeofenceDelegate> _Nullable)delegate;
...
/// Method to reset <code>MoEngageGeofenceDelegate</code> delegate for Default MoEngage Instance
- (void)resetGeofenceDelegate;
/// Method to reset <code>MoEngageGeofenceDelegate</code> delegate for  Secondary MoEngage Instance
/// \param appID MoEngage Account Identifier
///
